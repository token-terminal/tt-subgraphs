...
import { ERC20 } from '../generated/AaveTokenV2/ERC20'
...
export function getOrCreateToken(id: string): Token {
  ...
  if (token == null) {
    ...
    token.totalSupply = tokenContract.try_totalSupply().reverted
      ? ZERO_BD
      : correctForDecimals(tokenContract.try_totalSupply().value, token.decimals)
  }
...
export function createTokenHolder(id: string, governanceToken: GovernanceToken): TokenHolder {
