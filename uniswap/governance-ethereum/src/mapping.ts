...
import { Transfer, Uni } from '../generated/Uni/Uni'
...
function updateTransferEvents(event: Transfer): void {
  ...
  let contract = Uni.bind(Address.fromString(contractAddress))
  ...
  let transferAmountNative = correctForDecimals(event.params.amount, token.decimals)
